          ...
          mkDirectional = { side, keycode }:
            ...
            in [
              # resizing binds
              {
                ...
                when =
                  "activeEditorGroupIndex == ${idx.ours} && dance.mode == 'normal' && editorTextFocus";
              }
              {
                key = "ctrl+shift+${keycode}";
                command = "workbench.action.increaseViewWidth";
                when =
                  "activeEditorGroupIndex == ${idx.other} && dance.mode == 'normal' && editorTextFocus";
              }
              ...
              # switch sides binds 
              {
                ...
                when =
                  "activeEditorGroupIndex == ${idx.other} && !terminalFocus && !isInDiffEditor";
              }
