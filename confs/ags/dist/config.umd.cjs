(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("resource:///com/github/Aylur/ags/app.js"), require("resource:///com/github/Aylur/ags/widget.js"), require("resource:///com/github/Aylur/ags/service/battery.js"), require("resource:///com/github/Aylur/ags/utils.js"), require("resource:///com/github/Aylur/ags/variable.js"), require("resource:///com/github/Aylur/ags/service/hyprland.js"), require("resource:///com/github/Aylur/ags/service/network.js"), require("resource:///com/github/Aylur/ags/service/notifications.js")) : typeof define === "function" && define.amd ? define(["resource:///com/github/Aylur/ags/app.js", "resource:///com/github/Aylur/ags/widget.js", "resource:///com/github/Aylur/ags/service/battery.js", "resource:///com/github/Aylur/ags/utils.js", "resource:///com/github/Aylur/ags/variable.js", "resource:///com/github/Aylur/ags/service/hyprland.js", "resource:///com/github/Aylur/ags/service/network.js", "resource:///com/github/Aylur/ags/service/notifications.js"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.oleinags = factory(global.app, global.widget, global.battery, global.utils, global.variable, global.hyprland, global.network, global.notifications));
})(this, function(App, Widget, Battery, utils_js, Variable, Hyprland, Network, Notifications) {
  "use strict";
  const BatteryBar = (battery = Battery) => Widget.Box({
    connections: [[battery, (self2) => {
      const children = [];
    ...
    children: [
      Widget.Label({
        ...
        connections: [
          [
            1e3,
            (self2) => utils_js.execAsync(["date", "+%A, %B %d %I:%M:%S %p"]).then((date) => {
              self2.label = date;
            })
          ]
        ]
  ...
  const monitorWatcher = (app, windowBuilders) => {
    ...
    const numMonitors = JSON.parse(utils_js.exec("hyprctl monitors -j")).length;
    const shimMonitors = [];
  ...
  const buildWorkspacesChildren = (altIsDown, monitor) => {
    const thisMonitor = JSON.parse(utils_js.exec("hyprctl monitors -j")).find(
  ...
  const Workspaces = (monitor) => Widget.Box({
    ...
    connections: [
      [
        ...
        (self2) => {
          self2.children = buildWorkspacesChildren(altDown.value, monitor);
        }
      ],
      [
        altDown,
  ...
  addToggleableWindow(
    ...
    (v) => Launcher(
      "Forgot",
      utils_js.readFile(`${App.configDir}/assets/often_forgotten.md`).split("\n").map((v2) => ({ data: v2 })),
      v
    )
  );
  addToggleableWindow("Launcher", (v) => {
    const json = JSON.parse(utils_js.readFile("/home/oleina/.config/data/launcher.json"));
